...
`,Da=ee(js)`
  margin: 2px 0;
`;class za extends e.PureComponent{render(){const t=this.props.extensions;return e.createElement(pe.Consumer,null,(r=>e.createElement(e.Fragment,null,r.showExtensions&&Object.keys(t).map((r=>e.createElement(Da,{key:r},e.createElement(ya,null," ",r.substring(2),": ")," ",e.createElement(Sa,null,"string"==typeof t[r]?t[r]:JSON.stringify(t[r]))))))))}}function La({field:t}){return t.examples?e.createElement(e.Fragment,null,e.createElement(ya,null," ",_("examples"),": "),I(t.examples)?t.examples.map(((r,n)=>{const o=Xe(t,r),i=t.in?String(o):JSON.stringify(o);return e.createElement(e.Fragment,{key:n},e.createElement($a,null,i)," ")})):e.createElement(Na,null,Object.values(t.examples).map(((r,n)=>e.createElement("li",{key:n+r.value},e.createElement($a,null,Xe(t,r.value))," -"," ",r.summary||r.description))))):null}const Na=ee.ul`
  margin-top: 1em;
...
`,Uc=ee(Rc)`
  margin: 0 5px 0 0;
`,Wc=ee((t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(Bc,{className:o,onClick:i||void 0},e.createElement(Uc,{type:s},yt(s)),e.createElement(hi,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(Qc,{$deprecated:a},r),a?e.createElement(mi,{type:"warning"}," ",_("deprecated")," "):null)}))`
  padding: 10px;
  border-radius: 2px;
  margin-bottom: 4px;
  line-height: 1.5em;
...
`,ep=ee.div`
  ...
  line-height: 20px;
  border-radius: 4px;
`;class tp extends e.Component{render(){const{operation:t,inverted:r,hideHostname:n}=this.props;return e.createElement(pe.Consumer,null,(o=>e.createElement(Jc,null,e.createElement(Zc,{$inverted:r},e.createElement(Gc,{type:t.httpVerb,$compact:this.props.compact},t.httpVerb),e.createElement(Yc,null,t.path)),e.createElement(Xc,null,t.servers.map((r=>{const i=o.expandDefaultServerVariables?pt(r.url,r.variables):r.url,s=E(i);return e.createElement(Kc,{key:i},e.createElement(zs,{source:r.description||"",compact:!0}),e.createElement(Hc,null,e.createElement(ep,null,n||o.hideHostname?"/"===s?"":s:i,t.path)))}))))))}}class rp extends e.PureComponent{constructor(e){super(e),this.toggle=()=>{this.setState({expanded:!this.state.expanded})},this.state={expanded:!1}}render(){const{place:t,parameters:r}=this.props;return r&&r.length?e.createElement("div",{key:t},e.createElement(wi,{onClick:this.toggle},t," Parameters:",e.createElement(hi,{size:"1.5em",direction:this.state.expanded?"up":"down"})),this.state.expanded&&e.createElement(Mi,null,e.createElement("tbody",null,d(r,((t,r,n)=>e.createElement(ol,{key:t.name,isLast:r,isFirst:n,field:t,showExamples:!0})))))):null}}Object.defineProperty,Object.getOwnPropertyDescriptor;let np=class extends e.Component{constructor(){super(...arguments),this.switchMedia=({idx:e})=>{this.props.content&&void 0!==e&&this.props.content.activate(e)}}render(){const{content:t}=this.props;if(!t||!t.mediaTypes||!t.mediaTypes.length)return null;const r=t.activeMimeIdx,n=t.mediaTypes.map(((e,t)=>({value:e.name,idx:t}))),o=({children:t})=>this.props.withLabel?e.createElement(pa,null,t):t;return e.createElement(e.Fragment,null,e.createElement(o,null,this.props.renderDropdown({value:n[r].value,options:n,onChange:this.switchMedia,ariaLabel:"Content type"})),this.props.children(t.active))}};np=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([fa.observer],np);var op=Object.defineProperty,ip=Object.getOwnPropertySymbols,sp=Object.prototype.hasOwnProperty,ap=Object.prototype.propertyIsEnumerable,lp=(e,t,r)=>t in e?op(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,cp=(e,t)=>{for(var r in t||(t={}))sp.call(t,r)&&lp(e,r,t[r]);if(ip)for(var r of ip(t))ap.call(t,r)&&lp(e,r,t[r]);return e},pp=(e,t)=>{var r={};for(var n in e)sp.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(null!=e&&ip)for(var n of ip(e))t.indexOf(n)<0&&ap.call(e,n)&&(r[n]=e[n]);return r};const up=["path","query","cookie","header"];class dp extends e.PureComponent{orderParams(e){const t={};return e.forEach((e=>{var r,n,o;o=e,(r=t)[n=e.in]||(r[n]=[]),r[n].push(o)})),t}render(){const{body:t,parameters:r=[]}=this.props;if(void 0===t&&void 0===r)return null;const n=this.orderParams(r),o=r.length>0?up:[],i=t&&t.content,s=t&&t.description,a=t&&t.required;return e.createElement(e.Fragment,null,o.map((t=>e.createElement(rp,{key:t,place:t,parameters:n[t]}))),i&&e.createElement(mp,{content:i,description:s,bodyRequired:a}))}}function hp(t){var r=t,{bodyRequired:n}=r,o=pp(r,["bodyRequired"]);const i="boolean"==typeof n&&!!n,s="boolean"==typeof n&&!n;return e.createElement(e.Fragment,null,e.createElement(wi,{key:"header",onClick:o.onToggle},"Request Body schema: ",e.createElement(ws,cp({},o)),e.createElement(hi,{size:"1.5em",direction:o.expanded?"up":"down"})),i&&e.createElement(gp,null,"required"),s&&e.createElement(yp,null,"optional"))}function mp(t){const{content:r,description:n,bodyRequired:o}=t,{isRequestType:i}=r,[s,a]=e.useState(!1),l=()=>{a(!s)};return e.createElement(np,{content:r,renderDropdown:t=>e.createElement(hp,cp({bodyRequired:o,onToggle:l,expanded:s},t))},(({schema:t})=>s?e.createElement(e.Fragment,null,void 0!==n&&e.createElement(zs,{source:n}),"object"===(null==t?void 0:t.type)&&e.createElement(Ma,{constraints:(null==t?void 0:t.constraints)||[]}),e.createElement(Ml,{skipReadOnly:i,skipWriteOnly:!i,key:"schema",schema:t})):e.createElement(e.Fragment,null)))}const fp="\n  text-transform: lowercase;\n  margin-left: 0;\n  margin-top: -12px;\n  line-height: 1.5em;\n",gp=ee(ka)`
  ${fp}
`,yp=ee("div")`
  ${fp}
  color: ${({theme:e})=>e.colors.text.secondary};
  font-size: ${e=>e.theme.schema.labelsTextSize};
`;class bp extends e.PureComponent{render(){const{headers:t}=this.props;return void 0===t||0===t.length?null:e.createElement(e.Fragment,null,e.createElement(wi,null,"Response Headers:"),e.createElement(Mi,null,e.createElement("tbody",null,d(t,((t,r,n)=>e.createElement(ol,{isLast:r,isFirst:n,key:t.name,field:t,showExamples:!0}))))))}}var xp=Object.defineProperty,vp=Object.getOwnPropertySymbols,wp=Object.prototype.hasOwnProperty,kp=Object.prototype.propertyIsEnumerable,Op=(e,t,r)=>t in e?xp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;class Ep extends e.PureComponent{constructor(){super(...arguments),this.renderDropdown=t=>e.createElement(wi,{key:"header"},"Response Schema: ",e.createElement(ws,((e,t)=>{for(var r in t||(t={}))wp.call(t,r)&&Op(e,r,t[r]);if(vp)for(var r of vp(t))kp.call(t,r)&&Op(e,r,t[r]);return e})({},t)))}render(){const{description:t,extensions:r,headers:n,content:o}=this.props.response;return e.createElement(e.Fragment,null,t&&e.createElement(zs,{source:t}),e.createElement(za,{extensions:r}),e.createElement(bp,{headers:n}),e.createElement(np,{content:o,renderDropdown:this.renderDropdown},(({schema:t})=>e.createElement(e.Fragment,null,"object"===(null==t?void 0:t.type)&&e.createElement(Ma,{constraints:(null==t?void 0:t.constraints)||[]}),e.createElement(Ml,{skipWriteOnly:!0,key:"schema",schema:t})))))}}const jp=e.memo((function({title:t,empty:r,code:n,opened:o,className:i,onClick:s}){return e.createElement("button",{className:i,onClick:!r&&s||void 0,"aria-expanded":o,disabled:r},!r&&e.createElement(hi,{size:"1.5em",color:"#22174A",direction:o?"up":"down",float:"right"}),e.createElement(Pp,null,n," "),e.createElement(zs,{compact:!0,inline:!0,source:t}))})),$p=ee(jp)`
  display: block;
  border: 0;
  width: 100%;
  text-align: left;
