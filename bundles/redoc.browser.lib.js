...
`,mi=ee.div`
  ...
  `};
`,fi={left:"90deg",right:"-90deg",up:"-180deg",down:"0"},gi=ee(t=>e.createElement("svg",{className:t.className,style:t.style,version:"1.1",viewBox:"0 0 24 24",x:"0",xmlns:"http://www.w3.org/2000/svg",y:"0","aria-hidden":"true"},e.createElement("polygon",{points:"17.3 8.3 12 13.6 6.7 8.3 5.3 9.7 12 16.4 18.7 9.7 "})))`
...
`,fa=ee.div`
  ...
  font-size: 12px;
  color: #ee807f;
`;class ga extends e.Component{constructor(){super(...arguments),this.state={activeIdx:0},this.switchMedia=({idx:e})=>{void 0!==e&&this.setState({activeIdx:e})}}render(){const{activeIdx:t}=this.state,r=this.props.mediaType.examples||{},n=this.props.mediaType.name,o=e.createElement(fa,null,"No sample"),i=Object.keys(r);if(0===i.length)return o;if(i.length>1){const o=i.map((e,t)=>({value:r[e].summary||e,idx:t})),s=r[i[t]],a=s.description;return e.createElement(ya,null,e.createElement(ha,null,this.props.renderDropdown({value:o[t].value,options:o,onChange:this.switchMedia,ariaLabel:"Example"})),e.createElement("div",null,a&&e.createElement(Ms,{source:a}),e.createElement(ca,{example:s,mimeType:n})))}{const t=r[i[0]];return e.createElement(ya,null,t.description&&e.createElement(Ms,{source:t.description}),e.createElement(ca,{example:t,mimeType:n}))}}}const ya=ee.div`
  margin-top: 15px;
...
`,Wc=ee(Lc)`
  margin: 0 5px 0 0;
`,Vc=ee(t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(Qc,{className:o,onClick:i||void 0},e.createElement(Wc,{type:s},yt(s)),e.createElement(gi,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(Uc,{$deprecated:a},r),a?e.createElement(yi,{type:"warning"}," ",_("deprecated")," "):null)})`
  padding: 10px;
  border-radius: 2px;
  margin-bottom: 4px;
  line-height: 1.5em;
