...
`,fi={1:"24px",2:"20px",3:"1.27em"},yi={1:"600",2:"500",3:"500"},gi=e=>Y`
...
`,Da=ee(js)`
  margin: 2px 0;
`;class La extends e.PureComponent{render(){const t=this.props.extensions;return e.createElement(pe.Consumer,null,(r=>e.createElement(e.Fragment,null,r.showExtensions&&Object.keys(t).map((r=>e.createElement(Da,{key:r},e.createElement(ga,null," ",r.substring(2),": ")," ",e.createElement(Sa,null,"string"==typeof t[r]?t[r]:JSON.stringify(t[r]))))))))}}function za({field:t}){return t.examples?e.createElement(e.Fragment,null,e.createElement(ga,null," ",_("examples"),": "),I(t.examples)?t.examples.map(((r,n)=>{const o=Xe(t,r),i=t.in?String(o):JSON.stringify(o);return e.createElement(e.Fragment,{key:n},e.createElement($a,null,i)," ")})):e.createElement(Na,null,Object.values(t.examples).map(((r,n)=>e.createElement("li",{key:n+r.value},e.createElement($a,null,Xe(t,r.value))," -"," ",r.summary||r.description))))):null}const Na=ee.ul`
  margin-top: 1em;
...
`,Qc=ee(Rc)`
  margin: 0 5px 0 0;
`,Uc=ee((t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(Fc,{className:o,onClick:i||void 0},e.createElement(Qc,{type:s},gt(s)),e.createElement(hi,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(Bc,{$deprecated:a},r),a?e.createElement(mi,{type:"warning"}," ",_("deprecated")," "):null)}))`
  padding: 10px;
  border-radius: 2px;
  margin-bottom: 4px;
  line-height: 1.5em;
