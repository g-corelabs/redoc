...
`,Uc=ee(Rc)`
  margin: 0 5px 0 0;
`,Wc=ee((t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(Bc,{className:o,onClick:i||void 0},e.createElement(Uc,{type:s},gt(s)),e.createElement(hi,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(Qc,{$deprecated:a},r),a?e.createElement(mi,{type:"warning"}," ",_("deprecated")," "):null)}))`
  padding: 10px;
  border-radius: 2px;
  margin-bottom: 4px;
  line-height: 1.5em;
